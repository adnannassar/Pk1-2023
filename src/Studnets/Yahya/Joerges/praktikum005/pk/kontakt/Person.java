...
public class Person extends Kontakt {
    ...
    public boolean equals(Object o) {
        ...
        Person p = (Person) o;
        if (this.nachname.equals(p.getNachname()) && this.vorname.equals(p.getVorname()) && this.geburtstag.equals(p.geburtstag) && this.adresseBeruflich.equals(p.getAdresseBeruflich()) && this.adressePrivate.equals(p.getAdressePrivate()) ) return true;
        else return false;}

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), nachname, vorname, geburtstag, adresseBeruflich, adressePrivate);
    }
